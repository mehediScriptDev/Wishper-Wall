    ...
    <div className="lg:flex flex-col bg-cardbg border-r border-gray-200 shadow-sm p-4">
      ...
      <div className="mb-4">
        <input
          type="text"
          placeholder="Search..."
          className="w-full px-3 py-2 border rounded bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
      </div>
      ...
      {/* Bottom Pro Section */}
      <div className="mt-4 p-3 bg-gray-100 rounded-lg text-xs text-gray-600 flex flex-col gap-2">
      ...
      {/* User Profile */}
      <div className="mt-4 flex items-center gap-2 p-2 hover:bg-gray-100 rounded cursor-pointer">
